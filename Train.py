...
from model_arch import get_pdn_medium, Student, \
...
def get_argparse():
    ...
    parser.add_argument('-o', '--output_dir', default=r'output')
    ...
    parser.add_argument('-t', '--train_steps', type=int, default=180000)
...
def main(adclass):
    ...
    for iteration, (image_st, image_ae), image_penalty in zip(
        ...
        if iteration % 10000 == 0 and iteration > 0:
            ...
            torch.save(teacher, os.path.join(train_output_dir, 'teacher_{}.pth'.format(iteration)))
            torch.save(student, os.path.join(train_output_dir, 'student_{}.pth'.format(iteration)))
