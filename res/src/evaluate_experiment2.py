...
def parse_arguments():
    ...
    parser.add_argument(
        '--anomaly_maps_dir',
        default="/data0/mhxu/3090_4icv/code/RD4AD-mainM/CVPR627/MVTec_LOCO_AD_dataset",
        help='Path to the anomaly maps directory of the evaluated method.')

    parser.add_argument(
        '--output_dir',
        default='/data0/mhxu/3090_4icv/code/RD4AD-main/work3/CVPR627/iterm',
...
def main():
    ...
    for i in item_list:
        ...
        args.object_name=i
        print(i)
        args.output_dir=args.output_dir.replace("iterm", i)
